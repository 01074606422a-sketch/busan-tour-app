...
/* 양옆 여백 최소화 (모바일 화면을 위해 1.5rem으로 최적화) */
.block-container {
...
/* =========================================================
   [모바일/PC 반응형] 라디오 버튼 자동 줄바꿈 및 중앙 정렬
   ========================================================= */
...
div[role="radiogroup"] {
    display: flex !important;
    flex-direction: column !important;
    align-items: flex-start !important; /* 텍스트는 왼쪽 정렬 */
    gap: 12px !important;
    width: fit-content !important; /* 내용물 너비에 맞추되 */
    max-width: 100% !important; /* 모바일 화면을 넘지 않도록 방어 */
...
div[role="radiogroup"] label {
    ...
    white-space: normal !important; /* 박스를 넘으면 줄바꿈 허용 */
}
div[role="radiogroup"] label p {
    ...
    word-break: keep-all !important; /* 단어가 찢어지지 않게 예쁘게 줄바꿈 */
}
...
[data-testid="stForm"] {
    ...
    width: 100% !important;
    max-width: 800px !important; /* PC에서는 최대 800px까지만 커지게 방어 */
