...
/* =========================================================
   [진짜 최종 핵심] '페르소나 폼 내부의' 라디오 버튼만 중앙 정렬!
   (앞에 [data-testid="stForm"]을 붙여서 메뉴 탭은 건드리지 않음)
   ========================================================= */
...
[data-testid="stForm"] div[role="radiogroup"] {
    display: flex !important;
    flex-direction: column !important;
    align-items: flex-start !important; /* 텍스트는 왼쪽 정렬로 묶음 */
    gap: 12px !important;
    width: max-content !important; /* 박스 너비를 제일 긴 텍스트 크기에 딱 맞춤 */
...
/* 페르소나 테스트 폼 박스: 텅 빈 여백을 줄이기 위해 가로폭(max-width)과 패딩 축소 */
[data-testid="stForm"] {
    ...
    max-width: 800px !important; /* 폼이 너무 넓어 여백이 뜨는 현상 방지 */
...
QUESTIONS = [
    ...
    {"q": "Q6. 저녁 9시, 당신은 지금 어디에 있나요?", 
     "opts": ["광안리 야경을 안주 삼아 시원한 맥주 한 잔 들이켜는 중!", "깡통야시장에서 길거리 음식을 양손 가득 들고 먹방 중!", "따뜻한 숙소에서 반신욕을 강추하며 오늘의 피로를 푸는 중", "잔잔한 파도 소리를 들으며 조용한 밤바다를 산책하는 중"], 
