...
custom_css = """
<style>
/* [핵심] 가장 세련되고 덜 정적인 고딕체 웹폰트 (Pretendard) 로드 */
...
/* [핵심] 페르소나 테스트 질문-항목 열 맞춤 및 폰트 크기/스타일 교정 */
...
[data-testid="stForm"] .stRadio label p {
    font-size: 18px !important; /* 항목 글씨 크기 2pt 증가 */
    font-family: 'Pretendard', sans-serif !important; /* 덜 정적인 세련된 폰트 */
...
PERSONA_INFO = {
    ...
    "MZ 뚜벅이족": {"keywords": ["거리", "마 마을", "골목", "도보", "뚜벅이"], "desc": "대중교통으로 부산 곳곳을 부지런하게 누비는 활동적인 탐험가"},
...
if not st.session_state.test_completed:
    ...
    with st.form("persona_test"):
        ...
        for i, q_data in enumerate(QUESTIONS):
            ...
            # [핵심] 컬럼 분리를 제거하여 라디오 버튼 블록이 전체 너비에서 완벽하게 가운데 정렬되도록 수정
